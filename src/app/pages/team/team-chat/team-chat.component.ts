  ...
  salons = [
    {
      id: 1, name: "Général", msgs:
        [
          ...
          new Message(2, this.users[2], new Date("2021-05-01T17:43:07"), "Hi, salut les mecs"),
          new Message(3, this.users[3], new Date("2021-05-02T09:07:44"), "Guys ?"),

          new Message(4, this.users[1], new Date("2021-05-02T09:07:46"), "123**456**789"),
          new Message(5, this.users[2], new Date("2021-05-02T09:08:01"), "123**456**789**123**456"),
          new Message(6, this.users[3], new Date("2021-05-02T09:08:27"), "text*italic*text"),

          new Message(7, this.users[0], new Date("2021-05-02T09:12:51"), "Normal\n\n**Bold**\n\n*Italic*\n\n__Under__\n\n~~Strike~~\n\n***__~~All~~__***"),
        ]
    },
    {
